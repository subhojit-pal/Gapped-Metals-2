...
OPEN(UNIT=40, FILE = "Gold_BaNbO_126")
...
OPEN(UNIT=30, FILE = "Gold_BaNbO_126_wp_eps1") !GM
OPEN(UNIT=31, FILE = "Gold_BaNbO_126_wp_eps2") !Gold
...
!!BaNb2O6_VBa, composition_1_2_6, kpoints_16_12_8, Insulator
