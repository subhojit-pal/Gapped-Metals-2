...
OPEN(UNIT=43, FILE = "Gold_BaNbO_7824")
...
OPEN(UNIT=36, FILE = "Gold_BaNbO_7824_wp_eps1") !GM
OPEN(UNIT=37, FILE = "Gold_BaNbO_7824_wp_eps2") !Gold
...
!!Ba7Nb82O24_VBa, composition_7_8_24, kpoints_8_24_8

alphaModal_1 =69.1791D0
freqModal_1 =0.0215D0*(qe/h)
alphaModal_2 =94.1209D0
freqModal_2 =0.0438D0*(qe/h)
alphaModal_3 =66.833D0
freqModal_3 =0.0872D0*(qe/h)
alphaModal_4 =351.9936D0
freqModal_4 =0.1967D0*(qe/h)
alphaModal_5 =37.1564D0
freqModal_5 =0.2227D0*(qe/h)
alphaModal_6 =1.3619D0
freqModal_6 =0.6448D0*(qe/h)
alphaModal_7 =0.1616D0
freqModal_7 =2.5296D0*(qe/h)
alphaModal_8 =1.5587D0
freqModal_8 =5.0772D0*(qe/h)
alphaModal_9 =1.3843D0
freqModal_9 =8.4405D0*(qe/h)
alphaModal_10 =0.7517D0
freqModal_10 =16.0637D0*(qe/h)
alphaModal_11 =0.2107D0
freqModal_11 =27.1476D0*(qe/h)
alphaModal_12 =0.0695D0
...
WRITE(43,*) dist*1D9,' ,  ',bsum !print to file dist in nm and free energy in J/m^2
