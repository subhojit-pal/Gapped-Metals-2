...
OPEN(UNIT=41, FILE = "Gold_BaNbO_113")
...
OPEN(UNIT=32, FILE = "Gold_BaNbO_113_wp_eps1") !GM
OPEN(UNIT=33, FILE = "Gold_BaNbO_113_wp_eps2") !Gold
...
!!BaNbO3, composition_1_1_3, kpoints_40_40_40, Pristine

alphaModal_1 =9.4105D0
freqModal_1 =0.0215D0*(qe/h)
alphaModal_2 =17.6756D0
freqModal_2 =0.0438D0*(qe/h)
alphaModal_3 =19.2732D0
freqModal_3 =0.0872D0*(qe/h)
alphaModal_4 =451.2032D0
freqModal_4 =0.1967D0*(qe/h)
alphaModal_5 =53.9568D0
freqModal_5 =0.2227D0*(qe/h)
alphaModal_6 =0.2725D0
freqModal_6 =0.6448D0*(qe/h)
alphaModal_7 =0.1729D0
freqModal_7 =2.5296D0*(qe/h)
alphaModal_8 =1.2805D0
freqModal_8 =5.0772D0*(qe/h)
alphaModal_9 =1.5742D0
freqModal_9 =8.4405D0*(qe/h)
alphaModal_10 =0.7289D0
freqModal_10 =16.0637D0*(qe/h)
alphaModal_11 =0.2407D0
freqModal_11 =27.1476D0*(qe/h)
alphaModal_12 =0.0632D0
freqModal_12 =47.1511D0*(qe/h)
alphaModal_13 =0.0029D0
...
WRITE(41,*) dist*1D9,' ,  ',bsum !print to file dist in nm and free energy in J/m^2
