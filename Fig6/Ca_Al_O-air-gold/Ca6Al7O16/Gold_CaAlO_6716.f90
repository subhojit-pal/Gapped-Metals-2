...
OPEN(UNIT=40, FILE = "Gold_CaAlO_6716")
...
OPEN(UNIT=32, FILE = "Gold_CaAlO_6716_wp_eps1") !GM
OPEN(UNIT=33, FILE = "Gold_CaAlO_6716_wp_eps2") !Gold
...
!
 ...
 !Ca6Al7O16, composition_6_7_16, k-points_20_20_20, Pristine

alphaModal_1 =58.9601D0
freqModal_1 =0.0206D0*(qe/h)
alphaModal_2 =91.1774D0
freqModal_2 =0.0347D0*(qe/h)
alphaModal_3 =57.4068D0
freqModal_3 =0.0587D0*(qe/h)
alphaModal_4 =16.4729D0
freqModal_4 =0.1013D0*(qe/h)
alphaModal_5 =73.0451D0
freqModal_5 =0.1996D0*(qe/h)
alphaModal_6 =0.3949D0
freqModal_6 =0.3938D0*(qe/h)
alphaModal_7 =0.0706D0
freqModal_7 =0.9556D0*(qe/h)
alphaModal_8 =0.0987D0
freqModal_8 =2.2773D0*(qe/h)
alphaModal_9 =0.4594D0
freqModal_9 =6.4732D0*(qe/h)
alphaModal_10 =0.7938D0
freqModal_10 =10.2048D0*(qe/h)
alphaModal_11 =0.3705D0
freqModal_11 =18.2421D0*(qe/h)
alphaModal_12 =0.1655D0
freqModal_12 =30.9018D0*(qe/h)
alphaModal_13 =0.0059D0
...
WRITE(40,*) dist*1D9,',',bsum !print to file dist in nm and free energy in J/m^2
