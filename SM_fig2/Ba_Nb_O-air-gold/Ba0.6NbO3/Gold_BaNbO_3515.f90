...
OPEN(UNIT=44, FILE = "Gold_BaNbO_3515")
...
OPEN(UNIT=38, FILE = "Gold_BaNbO_3515_wp_eps1") !GM
OPEN(UNIT=39, FILE = "Gold_BaNbO_3515_wp_eps2") !Gold
...
!!Ba3Nb52O15_V2Ba, composition_3_5_15, kpoints_8_24_8
alphaModal_1 =10.1195D0
freqModal_1 =0.0215D0*(qe/h)
alphaModal_2 =15.8813D0
freqModal_2 =0.0438D0*(qe/h)
alphaModal_3 =17.5738D0
freqModal_3 =0.0872D0*(qe/h)
alphaModal_4 =83.8965D0
freqModal_4 =0.1967D0*(qe/h)
alphaModal_5 =35.407D0
freqModal_5 =0.2227D0*(qe/h)
alphaModal_6 =1.6775D0
freqModal_6 =0.6448D0*(qe/h)
alphaModal_7 =0.3952D0
freqModal_7 =2.5296D0*(qe/h)
alphaModal_8 =2.4751D0
freqModal_8 =5.0772D0*(qe/h)
alphaModal_9 =0.8565D0
freqModal_9 =8.4405D0*(qe/h)
alphaModal_10 =0.8088D0
freqModal_10 =16.0637D0*(qe/h)
alphaModal_11 =0.1615D0
freqModal_11 =27.1476D0*(qe/h)
alphaModal_12 =0.0824D0
...
WRITE(44,*) dist*1D9,' ,  ',bsum !print to file dist in nm and free energy in J/m^2
